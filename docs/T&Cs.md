...
8.4. The Prize will be awarded no earlier than the ratification by the Polkadot Fellowship of version 0.7 of the JAM protocol. The payment will be made by the Foundation within 30-days of the receipt of a valid invoice issued in line with this invoice template.
